...
namespace Cip.Imaging.BlobDetection
{
    ...
    public class BlobSizeFilter
    {
        ...
        public BlobSizeFilter(bool verboseOutput, int minWidth, int minHeight, int maxWidth, int maxHeight, double averageDeviation)
        {
        ...
        public IEnumerable<Blob> Process(IEnumerable<Blob> blobs)
        {
            ...
            var result = blobs.Where(b => b.BoundingBox.Width >= MinWidth && b.BoundingBox.Width <= MaxWidth && b.BoundingBox.Height >= MinHeight && b.BoundingBox.Height <= MaxHeight);
            ...
            int upperAverageWidth = (int)(averageWidth * (1.0 + AverageDeviation));
            int upperAverageHeight = (int)(averageHeight * (1.0 + AverageDeviation));
            int lowerAverageWidth = (int)(averageWidth * AverageDeviation);
            int lowerAverageHeight = (int)(averageHeight * AverageDeviation);
